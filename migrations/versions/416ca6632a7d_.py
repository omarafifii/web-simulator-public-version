...
Revision ID: 416ca6632a7d
Revises: f66b0be27023
Create Date: 2021-01-25 17:12:45.427754
...
revision = '416ca6632a7d'
down_revision = 'f66b0be27023'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    #     batch_op.add_column(sa.Column('base_vat', sa.Float(), nullable=True))
    #     batch_op.add_column(sa.Column('new_vat', sa.Float(), nullable=True))

    # with op.batch_alter_table('project', schema=None) as batch_op:
    #     batch_op.add_column(sa.Column('date', sa.Text(), nullable=True))
    #     batch_op.add_column(sa.Column('end_price', sa.Text(), nullable=False))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('project', schema=None) as batch_op:
        batch_op.drop_column('end_price')
        batch_op.drop_column('date')

    with op.batch_alter_table('init_data', schema=None) as batch_op:
        batch_op.drop_column('new_vat')
        batch_op.drop_column('base_vat')
