...
Revision ID: 48f3f5b3c64b
Revises: 4f611d011648
Create Date: 2020-12-30 19:49:27.124198
...
revision = '48f3f5b3c64b'
down_revision = '4f611d011648'
branch_labels = None
depends_on = None
...
#     op.drop_table('zero_price_level')
    with op.batch_alter_table('project', schema=None) as batch_op:
        batch_op.alter_column('msu',
               existing_type=sa.FLOAT(),
               nullable=False)
        batch_op.alter_column('vsu',
               existing_type=sa.FLOAT(),
               nullable=False)
