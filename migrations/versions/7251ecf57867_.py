...
Revision ID: 7251ecf57867
Revises: 416ca6632a7d
Create Date: 2021-01-25 17:17:00.438306
...
revision = '7251ecf57867'
down_revision = '416ca6632a7d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('project', schema=None) as batch_op:
        batch_op.add_column(sa.Column('end_price', sa.Text(), nullable=True))
