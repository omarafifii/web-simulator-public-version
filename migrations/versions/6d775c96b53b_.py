...
Revision ID: 6d775c96b53b
Revises: 833492cc774a
Create Date: 2021-01-03 15:55:02.355758
...
revision = '6d775c96b53b'
down_revision = '833492cc774a'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('CHEEZY 450G', sa.FLOAT(), nullable=True),
