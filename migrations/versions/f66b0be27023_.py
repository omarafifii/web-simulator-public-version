...
Revision ID: f66b0be27023
Revises: 6d775c96b53b
Create Date: 2021-01-10 16:01:21.878904
...
revision = 'f66b0be27023'
down_revision = '6d775c96b53b'
branch_labels = None
depends_on = None
...
#     op.drop_table('hbu_saudi')
    with op.batch_alter_table('init_data', schema=None) as batch_op:
        batch_op.alter_column('base_price',
               ...
               nullable=False)
        batch_op.alter_column('group_brand',
               existing_type=sa.TEXT(),
               nullable=False)
        batch_op.alter_column('group_manufacturer',
               existing_type=sa.TEXT(),
               nullable=False)
        batch_op.alter_column('group_segments',
               existing_type=sa.TEXT(),
               nullable=False)
        ...
        batch_op.alter_column('project_id',
               existing_type=sa.BIGINT(),
               nullable=False)
        batch_op.alter_column('sku_name',
               existing_type=sa.TEXT(),
               nullable=False)
        batch_op.create_unique_constraint(batch_op.f('uq_init_data_sku_name'), ['sku_name'])
        batch_op.create_foreign_key(batch_op.f('fk_init_data_project_id_project'), 'project', ['project_id'], ['id'])
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('init_data', schema=None) as batch_op:
        batch_op.drop_constraint(batch_op.f('fk_init_data_project_id_project'), type_='foreignkey')
